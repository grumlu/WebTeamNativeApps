...
namespace WebTeamWindows.View
{
    ...
    /// </summary>
    public sealed partial class WebTeamView_old : Page
    {
        ...
        public WebTeamView_old()
        {
            ...
            this.navigationHelper.GoBackCommand = new WebTeamWindows.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
